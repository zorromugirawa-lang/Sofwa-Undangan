...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['action']) && $_POST['action'] === 'update') {
        ...
        try {
            ...
            $sql = "UPDATE templates SET name=:name, category=:category, thumbnail=:thumbnail, price=:price, path=:path WHERE id=:id";
            $stmt = $conn->prepare($sql);
            $stmt->execute([
                'name' => $name, 'category' => $category, 'thumbnail' => $thumbnail,
                'price' => $price, 'path' => $path, 'id' => $id
            ]);
        ...
        try {
            ...
            $sql = "INSERT INTO templates (name, category, thumbnail, price, path) VALUES (:name, :category, :thumbnail, :price, :path)";
            $stmt = $conn->prepare($sql);
            $stmt->execute([
                'name' => $name, 'category' => $category, 'thumbnail' => $thumbnail,
                'price' => $price, 'path' => $path
            ]);
...
if ($conn !== null) {
    try {
        $stmt = $conn->query("SELECT * FROM templates ORDER BY id ASC");
        if ($stmt) {
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .table-header h2 {
            font-family: 'Playfair Display', serif; font-size: 18px; color: var(--primary);
        }
        ...
        .btn-add {
            ...
            background: var(--gradient); color: var(--white); font-size: 14px;
            font-weight: 600; font-family: 'Poppins', sans-serif; cursor: pointer;
            box-shadow: 0 4px 12px rgba(139, 94, 60, 0.25); transition: all 0.3s ease;
            display: inline-flex; align-items: center; gap: 8px;
        }

        .btn-add:hover { transform: translateY(-2px); box-shadow: 0 8px 20px rgba(139, 94, 60, 0.35); }
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="admin_digital.php" class="active"><i class="fas fa-desktop"></i> Undangan Digital</a>
            <a href="admin_cetak.php"><i class="fas fa-print"></i> Undangan Cetak</a>
        ...
        <div class="topbar">
            <div style="display: flex; align-items: center; gap: 12px;">
                ...
                <div class="topbar-left">
                    ...
                    <p>Kelola katalog template digital</p>
                </div>
            </div>
            <div class="topbar-right">
                <a href="admin_index.php" class="btn-back"><i class="fas fa-arrow-left"></i> <span>Dashboard</span></a>
                <a href="index.php" target="_blank" class="btn-view"><i class="fas fa-external-link-alt"></i> <span>Lihat Website</span></a>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="table-card">
                <div class="table-header">
                    <h2><i class="fas fa-list" style="margin-right: 8px; opacity: 0.5;"></i>Daftar Template</h2>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="name" value="<?php echo htmlspecialchars($t['name']); ?>" form="update_form_<?php echo $t['id']; ?>">
                                </td>
                                <td><input type="text" name="category" value="<?php echo htmlspecialchars($t['category']); ?>" form="update_form_<?php echo $t['id']; ?>"></td>
                                <td><input type="number" name="price" value="<?php echo htmlspecialchars($t['price']); ?>" form="update_form_<?php echo $t['id']; ?>"></td>
                                <td><input type="text" name="path" value="<?php echo htmlspecialchars($t['path']); ?>" form="update_form_<?php echo $t['id']; ?>" style="font-size: 12px;"></td>
                                <td>
                                    <input type="file" name="thumbnail_file" accept="image/*" form="update_form_<?php echo $t['id']; ?>">
                                </td>
                                <td>
                                    <div class="btn-group">
            ...
            <div class="form-card">
                <div class="form-card-header">
                    <h2><i class="fas fa-plus-circle" style="margin-right: 8px; opacity: 0.5;"></i>Tambah Template Baru</h2>
                </div>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Contoh: Template Elegan" required>
                            </div>
                            <div class="form-group">
                                <label>Kategori</label>
                                <input type="text" name="category" value="Pernikahan" placeholder="Pernikahan / Khitanan" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="path" placeholder="https://contoh.com/preview" required>
                            </div>
                        </div>
